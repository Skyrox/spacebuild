...
local function GetAboutPanel(frame)
	...
	mylist:AddLine( "" )
	mylist:AddLine( "SpaceAgeMP (Includes fixes and optimization to Orginal Spacebuild) - Doridian" )
	mylist:AddLine( "https://github.com/SpaceAgeMP/spacebuild" )
	mylist:AddLine( "" )
	mylist:AddLine( "Spacebuild Fixes and Optimization - Skyrox" )
	mylist:AddLine( "[Caex] Spacebuild - https://discord.gg/eJTXc2y" )
	--
