...
function ENT:SendData(ply)
	...
	if self.sbenvironment.bloom and self.sbenvironment.bloom.Col_r then
		...
		net.WriteInt(self.sbenvironment.bloom.Col_b or 0, 16)
		net.WriteFloat(self.sbenvironment.bloom.SizeX or 0)
		net.WriteFloat(self.sbenvironment.bloom.SizeY or 0)
		net.WriteFloat(self.sbenvironment.bloom.Passes or 0)
		net.WriteFloat(self.sbenvironment.bloom.Darken or 0)
		net.WriteFloat(self.sbenvironment.bloom.Multiply or 1)
		net.WriteFloat(self.sbenvironment.bloom.Color or 0)
	else
		net.WriteBool(false)
	end
	...
	if self.sbenvironment.color and self.sbenvironment.color.Color then
		...
		net.WriteInt(self.sbenvironment.color.AddColor_b or 0, 16)
		net.WriteInt(self.sbenvironment.color.MulColor_r or 1, 16)
		net.WriteInt(self.sbenvironment.color.MulColor_g or 1, 16)
		net.WriteInt(self.sbenvironment.color.MulColor_b or 1, 16)
		net.WriteFloat(self.sbenvironment.color.Brightness or 0)
		net.WriteFloat(self.sbenvironment.color.Contrast or 0)
		net.WriteFloat(self.sbenvironment.color.Color or 0)
	else
		net.WriteBool(false)
	end
